                ...
                GitProgressSupport support = new GitProgressSupport() {
                    public void perform() {
                        try {
                            ...
                            Map<File, FileInformation> interestingFiles = GitCommand.getInterestingStatus(root, file);
                            ...
                            Git.LOG.log(Level.FINE, "fileDeletedImpl(): File: {0} {1}", new Object[] {file.getAbsolutePath(), ex.toString()}); // NOI18N
                        }             
                    }
                };
