...
public class CustomWizardPanel implements WizardDescriptor.Panel<WizardDescriptor> {
    ...
    CustomWizardPanel(CustomActionBuilder builder) {
    ...
    public Component getComponent() {
        if (component == null) {
            component = new CustomVisualPanel(this, builder);
        }
        return component;
    }
    ...
    // return new HelpCtx(SampleWizardPanel.class);
    }
